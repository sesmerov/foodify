...
<body class="bg-gray-100">
    ...
    <div class="max-w-2xl mx-auto mt-10 bg-white p-8 rounded-2xl shadow-lg mb-8">
        ...
        <form action="index.php" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" class="px-6 py-3 bg-red-500 text-white rounded-lg hover:bg-red-700 transition">Añadir Plato</button>
            </div>
        </form>
    </div>
    <br><br><br>
